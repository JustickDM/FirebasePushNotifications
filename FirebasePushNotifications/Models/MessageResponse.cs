...
namespace FirebasePushNotifications.Models
{
    public class MessageResponse
    {
        ...
        private long Success { get; set; }

        public ICollection<string> SuccessfulTokens { get; set; }

        /// <summary>
        /// Number of messages that could not be processed.
        /// </summary>
        [JsonProperty(PropertyName = "failure")]
        private long Failure { get; set; }

        public ICollection<string> FailedTokens { get; set; }
